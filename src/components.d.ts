...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    PackagingMaterialSelector: typeof import('./components/PackagingMaterialSelector.vue')['default']
    ...
    RawMaterialSelector: typeof import('./components/RawMaterialSelector.vue')['default']
